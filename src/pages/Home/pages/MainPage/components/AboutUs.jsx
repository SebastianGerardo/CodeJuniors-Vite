...
const AboutUs = () => {
  return (
    <div id='nosotros' className="py-20 bg-gray-50 scroll-smooth">
    <div className="container mx-auto px-6 md:px-12 xl:px-32">
        <div className="mb-16 text-center">
            <h2 className="mb-4 text-center text-2xl text-gray-900 font-bold md:text-4xl">Equipo detrás de CodeJuniors</h2>
            <p className="text-gray-600 lg:w-8/12 lg:mx-auto">Codejuniors es una plataforma en línea que conecta a desarrolladores junior con empresas en busca de talentos emergentes en el campo de la programación. </p>
        </div>
